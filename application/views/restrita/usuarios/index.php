                          ...
                          <?php foreach ($usuarios as $usuario): ?>
                            <tr>
                              ...
                              <td><?php echo ($usuario->active == 1 ? 
                                '<span class="badge badge-success">Ativo</span>' : '<span class="badge badge-danger">Inativo</span>'); ?></td>
                              <td>
                                <a href="<?php echo base_url('restrita/usuarios/core/' . $usuario->id); ?>" class="btn btn-sm btn-icon btn-primary">
                                  <i class="far fa-edit"></i>  Editar</a>
                                <a href="<?php echo base_url('restrita/usuarios/delete/' . $usuario->id); ?>" class="btn btn-sm btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão"><i class="fas fa-times"></i>  Excluir</a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
